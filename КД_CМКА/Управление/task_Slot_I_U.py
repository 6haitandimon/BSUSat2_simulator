...
try:
    ...
    for i in range(0, 1):
        ...
        print("Voltage Shunt ={:7.4f}".format(voltage_s), "Voltage Bus ={:7.4f}".format(voltage_b),
              "Current ={:8.5f}".format(current))
        ...
        for slot in range(slot,
                          slot + 1):  # 1-Radio1 #2-Battery1 #3-Reserve #4-Camera #5-GPS #6-Reserve #7-Battery2 #8-Coils #9-Radio2 #10-SolarSensors
        ...
        for i in range(0, 3):  # repeat read parameters
            ...
            print("Slot {:d}".format(slot), "Voltage Shunt ={:7.4f}".format(voltage_s),
                  "Voltage Bus ={:7.4f}".format(voltage_b), "Current ={:8.5f}".format(current))
