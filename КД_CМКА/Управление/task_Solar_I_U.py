...
try:
    ...
    while True:
        ...
        print("{:7.4f}".format(voltage_ix_minus),"   {:8.5f}".format(current_ix_minus),"    {:7.4f}".format(voltage_ix_plus),"  {:8.5f}".format(current_ix_plus),"   {:7.4f}".format(voltage_iy_minus),"   {:8.5f}".format(current_iy_minus),"   {:7.4f}".format(voltage_iy_plus),"  {:8.5f}".format(current_iy_plus))  
        count=count+1        
