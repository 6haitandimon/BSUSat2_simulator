...
try:
    ...
    while True:
        ...
        B=2.531972392e-4
        C=1.840753501e-7
        Temperature1 = 1/(A+B*math.log(R_termistor1)+C*math.log(R_termistor1)*math.log(R_termistor1)*math.log(R_termistor1))
        Temperature1-=273.15
        ...
        Temperature2 = 1/(A+B*math.log(R_termistor2)+C*math.log(R_termistor2)*math.log(R_termistor2)*math.log(R_termistor2))
        Temperature2-=273.15
        ...
        if count%10 == 0:
            print(f"Battary1:Voltage11  Current11  Voltage21  Current21  Temperature1 Battary2:Voltage12  Current12  Voltage22  Current22  Temperature2")
        
        print("        {:7.4f}".format(voltage_bat1_1),"    {:8.5f}".format(current_bat1_1),"   {:7.4f}".format(voltage_bat2_1),"  {:8.5f}".format(current_bat2_1),"  {:7.3f}".format(Temperature1),"             {:7.4f}".format(voltage_bat1_2),"    {:8.5f}".format(current_bat1_2),"   {:7.4f}".format(voltage_bat2_2),"  {:8.5f}".format(current_bat2_2),"  {:7.3f}".format(Temperature2))  
        count=count+1
