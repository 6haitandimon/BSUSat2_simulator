...
MAX_SIMPLE_CAN_MSG_SIZE_BYTES = const(300)

# Add specific class for ALL THE CMDS
SEND_FREE_FRAME_CMD_ID = const(0x01)

SEND_FILE_CFG_CMD_ID = const(0x2E)
SEND_FILE_CMD_ID = const(0x2D)

START_PAGE_TRANSFER_CMD_ID = const(0x25)
END_PAGE_TRANSFER_CMD_ID = const(0x26)
SEND_PAGE_CMD_ID = const(0x2A)


FILE_TRANSFER_CFG_CMD = "file_transfer_cfg"
MSGPACK_COMMAND_LITERAL_TOKEN = u"cmd"
MSGPACK_FILENAME_LITERAL_TOKEN = u"filename"
MSGPACK_FILE_SIZE_LITERAL_TOKEN: str = u"file_size"
MSGPACK_COMMENT_LITERAL_TOKEN = u"comment"
MSGPACK_PARAMETER_LITERAL = u"param"
MSGPACK_DATA_LITERAL = u"data"

CHUNK_DATA_SIZE = const(8)
FILE_PAGE_SIZE = const(16_384)
